...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card-header mt-2">
            <h1 class="text-success text-center">Results search for car by City </h1>
        </div>
        <!-- start category -->
        <div class="card mt-2">
                        ...
                        <div class="col-md-4">
                            <div class="card" style="width: 18rem;">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Car Country: {{$car->country->country_name}}</li>
                                    <li class="list-group-item">Car City: <span class="text-success font-weight-bold">{{$car->region->region_name}}</span></li>
