...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card-header mt-2">
            <h1 class="text-success text-center">Results search for car by country</h1>
        </div>
        <!-- start category -->
        <div class="card mt-2">
            <div class="card-body col-md-12">
                <div class="row">
                    @foreach($car_by_country as $car)
                        <div class="col-md-4">
                            <div class="card" style="width: 18rem;">
                                <img src="storage/{{$car->car_photo}}" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Car Name: {{$car->marque->marque_name}}</h5>
